...
public class TestAssertions{
    ...
    public void asset_car_equal_doors(){
        Car car1 = new Volvo240(2, 100, Color.black, "Volvo240", 3, 7,0, 90);
        assertEquals(2, car1.getNrDoors());
    }

    @Test
    public void assert_volvo_equal_doors(){
        Car Volvo = new Volvo240(4, 100, Color.red, "Volvo240", 0, 1,2,90);
        assertEquals(4, Volvo.getNrDoors());
    }

    @Test
    public void assert_saab_equal_doors(){
        Car saab = new Saab95(2, 100, Color.red, "Saab95", 0, 1,2, 90);
        assertEquals(2, saab.getNrDoors());
    }

    @Test
    public void testTurboOnAndOff() {
        Saab95 saab = new Saab95(4, 200, Color.blue, "Saab95", 0, 0, 0, 90);
    ...
    public void test_change_in_pos(){
        Car car = new Volvo240(4, 200, Color.blue, "Car", 10, 0, 0, 90);
        car.move();
    ...
    public void test_gas_works(){
        Volvo240 volvo = new Volvo240(4, 100, Color.red, "Volvo240", 0, 0,0, 90);
        volvo.gas(0.5);
    ...
    public void test_brake_works(){
        Volvo240 volvo = new Volvo240(4, 100, Color.red, "Volvo240", 5, 0,0, 90);
        volvo.brake(0.5);
    ...
    public void test_gas_works_normal_car(){
        Car car = new Volvo240(4, 100, Color.red, "Volvo240", 0, 0,0,90);
        car.startEngine();
        car.gas(0.5);
    ...
    public void test_coordinates_car(){
        Car car = new Volvo240(4, 100, Color.red, "Volvo240", 0, 10,20, 90);
        List<Double> coordinateList = new ArrayList<>();
    ...
    public void car_should_not_gas_over_1(){
        Car car = new Volvo240(4, 100, Color.red, "Volvo240", 10, 10,20, 90);
        car.gas(2);
    ...
    public void car_speed_should_not_exceed_enginePower(){
        Car car = new Volvo240(4, 100, Color.red, "Volvo240", 99.5, 10,20, 90);
        car.gas(0.9);
